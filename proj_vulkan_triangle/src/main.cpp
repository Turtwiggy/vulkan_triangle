...
static void
SetupVulkan(const char** extensions, uint32_t extensions_count)
{
  VkResult err;
...
main(int, char**)
{
  ...
  SDL_Window*     window = SDL_CreateWindow(
    "Dear ImGui SDL2+Vulkan example", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
